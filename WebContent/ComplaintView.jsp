            ...
            <div class="col-12 col-lg-9 col-xl-7">
              ...
              >
                <div class="card-body p-4 p-md-5">
                  ...
                  <%
                  ArrayList<ComplaintRegister> arr = (ArrayList<ComplaintRegister>) request.getAttribute("arrlist");
                  ArrayList<String> arrstat = (ArrayList<String>) request.getAttribute("arrstatus");
                  	if(arr!=null)
                  	{
                      ...
                      <div class="col-md-12 mb-4 pb-2">
                        ...
                        <div class="compcateg" onclick = "compPage()"style="width:100%;height:100%;border:2px solid yellow;padding:10px 0px 20px 10px;border-radius:4px;box-shadow:0 5px 5px yellow;cursor:pointer;">
                          <h3 style="color:#6a5acd">Complaint ID:<%= arr.get(i).getComplaintId()%>
                          -<%= arr.get(i).getComplaintType()%> </h3>
			  			  <p style="color:#6a5acd">Description:
			  			  <%= arr.get(i).getProblem()%></p>
			  			  <%if(arrstat.get(i).equals("inprogress")){ %>
