            ...
            <div class="col-12 col-lg-9 col-xl-7">
              ...
              >
                <div class="card-body p-4 p-md-5">
                  ...
                  <%
                  ArrayList<ComplaintRegister> arr = (ArrayList<ComplaintRegister>) request.getAttribute("arr");
                  	if(arr!=null)
                  	{
                      ...
                      <div class="col-md-12 mb-4 pb-2">
                        ...
                        <div class="compcateg" onclick = "compPage()"style="width:100%;height:100%;border:2px solid yellow;padding:10px 0px 20px 10px;border-radius:4px;box-shadow:0 5px 5px yellow;cursor:pointer;">
                          ...
                          -<%= arr.get(i).getComplaintType()%> </h3>
			  			  ...
			  			  <form action="AdminComplaintStatus" method="post">
			  			  <input type="hidden" name="complaintid" value="<%= arr.get(i).getComplaintId() %>" >
